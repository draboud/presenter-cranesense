(() => {
  ...
  var deviceTestTxt = document.querySelector(".device-test-txt");
  var userAgent = navigator.userAgent || navigator.vendor || window.opera;
  var isIOS = /iPad|iPhone|iPod/.test(userAgent) && !window.MSStream;
  var isAndroid = /Android/i.test(userAgent);
  if (isIOS) {
    deviceTestTxt.innerText = "\u{1F4F1} Device Detected: iOS";
    deviceTestTxt.style.color = "#007AFF";
    deviceTestTxt.style.background = "#E5F1FF";
  } else if (isAndroid) {
    deviceTestTxt.innerText = "\u{1F916} Device Detected: Android";
    deviceTestTxt.style.color = "#3DDC84";
    deviceTestTxt.style.background = "#E8F9F0";
  } else {
    deviceTestTxt.innerText = "\u{1F4BB} Device Detected: Desktop / Other";
